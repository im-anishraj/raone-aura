...
from aura.core.trusted_folders import has_trustable_content, trusted_folders_manager
from aura.setup.trusted_folders.trust_folder_dialog import (
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        "or custom from ~/.aura/agents/NAME.toml)",
    )
...
def check_and_resolve_trusted_folder() -> None:
    try:
        ...
        rprint(
            ...
            "[yellow]The directory you started aura from has been deleted. "
...
def main() -> None:
    ...
    from aura.cli.cli import run_cli
