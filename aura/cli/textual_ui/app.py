...
from aura import __version__ as CORE_VERSION
from aura.cli.clipboard import copy_selection_to_clipboard
from aura.cli.commands import CommandRegistry
from aura.cli.plan_offer.adapters.http_whoami_gateway import HttpWhoAmIGateway
from aura.cli.plan_offer.decide_plan_offer import (
    PlanType,
    decide_plan_offer,
    plan_offer_cta,
    resolve_api_key_for_plan,
)
from aura.cli.plan_offer.ports.whoami_gateway import WhoAmIGateway
from aura.cli.terminal_setup import setup_terminal
from aura.cli.textual_ui.handlers.event_handler import EventHandler
from aura.cli.textual_ui.widgets.approval_app import ApprovalApp
from aura.cli.textual_ui.widgets.banner.banner import Banner
from aura.cli.textual_ui.widgets.chat_input import ChatInputContainer
from aura.cli.textual_ui.widgets.compact import CompactMessage
from aura.cli.textual_ui.widgets.config_app import ConfigApp
from aura.cli.textual_ui.widgets.context_progress import ContextProgress, TokenState
from aura.cli.textual_ui.widgets.load_more import HistoryLoadMoreRequested
from aura.cli.textual_ui.widgets.loading import LoadingWidget, paused_timer
...
from aura.cli.textual_ui.widgets.path_display import PathDisplay
from aura.cli.textual_ui.widgets.question_app import QuestionApp
from aura.cli.textual_ui.widgets.teleport_message import TeleportMessage
...
from aura.cli.update_notifier import (
...
from aura.cli.update_notifier.update import do_update
from aura.core.agent_loop import AgentLoop, TeleportError
from aura.core.agents import AgentProfile
from aura.core.autocompletion.path_prompt_adapter import render_path_prompt
from aura.core.config import AuraConfig
from aura.core.paths.config_paths import HISTORY_FILE
from aura.core.session.session_loader import SessionLoader
from aura.core.teleport.types import (
...
class AuraTerminal(App):  # noqa: PLR0904
    ...
    async def on_config_app_config_closed(
        ...
        if message.changes:
            AuraConfig.save_updates(message.changes)
...
"""
    ...
    async def _check_update(self) -> None:
        ...
        message = f"{update_message_prefix}\nPlease update mistral-aura with your package manager"
...
def _print_session_resume_message(session_id: str | None) -> None:
    ...
    print()
    print("To continue this session, run: aura --continue")
    print(f"Or: aura --resume {session_id}")
...
def run_textual_ui(
    ...
    update_notifier = PyPIUpdateGateway(project_name="mistral-aura")
