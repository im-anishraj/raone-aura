...
from aura.core.paths.config_paths import resolve_local_agents_dir
from aura.core.paths.global_paths import GLOBAL_AGENTS_DIR
...
class AgentManager:
    def __init__(
        self,
        config_getter: Callable[[], AuraConfig],
        ...
        self._cached_config: AuraConfig | None = None
