...
from aura.core.teleport.git import GitRepoInfo, GitRepository
from aura.core.teleport.nuage import (
    GitRepoConfig,
    NuageClient,
    TeleportSession,
    VibeNewSandbox,
...
# TODO(aura-nuage): update URL once prod has shared aura-nuage workers
...
class TeleportService:
    ...
    def _validate_config(self) -> None:
        # TODO(aura-nuage): update error message once prod has shared aura-nuage workers
