...
from aura.core.paths.config_paths import CONFIG_FILE, HISTORY_FILE, unlock_config_paths
from aura.core.utils import logger
...
def parse_arguments() -> Arguments:
    parser = argparse.ArgumentParser(description="Run Mistral Aura in ACP mode")
    parser.add_argument(
...
def main() -> None:
    ...
    from aura.acp.acp_agent_loop import run_acp_server
