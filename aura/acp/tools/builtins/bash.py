...
from aura.acp.tools.base import AcpToolState, BaseAcpTool
from aura.core.tools.base import BaseToolState, InvokeContext, ToolError
from aura.core.tools.builtins.bash import Bash as CoreBashTool, BashArgs, BashResult
from aura.core.types import ToolCallEvent, ToolResultEvent, ToolStreamEvent
...
class Bash(CoreBashTool, BaseAcpTool[AcpBashState]):
    prompt_path = AURA_ROOT / "core" / "tools" / "builtins" / "prompts" / "bash.md"
    state: AcpBashState
