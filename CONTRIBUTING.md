# Contributing to Mistral Aura

Thank you for your interest in Mistral Aura! We appreciate your enthusiasm and support.

## Current Status

**Mistral Aura is in active development** — our team is iterating quickly and making lots of changes under the hood. Because of this pace, we may be slower than usual when reviewing PRs and issues.
...
If you have questions about using Mistral Aura, please check the [README](README.md) first. For other inquiries, feel free to open a discussion or issue.

Thank you for helping make Mistral Aura better! 🙏
